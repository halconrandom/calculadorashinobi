...
while (respuesta.toLowerCase() != "Golpes" || respuesta.toLowerCase() != "Tecnicas" ){
    if (respuesta == "golpes"){
        ...
        let respuesta2 = alert ("El daño total a tu personaje tras recibir "+fuerzaEnemigo+" KG de fuerza es de " +totalDañoFuerza +" KG de daño total.")
        break;
        ...
        console.log(calculo_tecnica)
        let totalDañotecnica = (parseInt(chakraEnemigo) + parseInt(calculo_tecnica))
        let totalDañoChakra = (chakraPJ - totalDañotecnicate)
        let respuesta2 = alert ("El total de daño de la tecnica del rival es de "+ totalDañotecnica + " U/C. \nTu chakra restante es de "+ totalDañoChakra + "U/C")
        break;
    } else {
